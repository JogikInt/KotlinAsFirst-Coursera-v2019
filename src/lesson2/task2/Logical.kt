...
fun daysInMonth(month: Int, year: Int): Int {
    return if ((year % 100 == 0) xor (year % 400 != 0) && year % 4 == 0 && month == 2) 29 else {
        if (month == 2) 28 else if (month == 4 || month == 6 || month == 9 || month == 11) 30 else 31
    }
...
fun brickPasses(a: Int, b: Int, c: Int, r: Int, s: Int): Boolean = (a <= r) && (b <= s) || (b <= r) && (a <= s) ||
        (b <= r) && (c <= s) || (c <= r) && (b <= s) || (a <= r) && (c <= s) || (c <= r) && (a <= s)
